...
const Fellows = () => {
  return <div className={styles.container}>Fellows</div>;
};
        ...
        <MDBCardBody>
          ...
          <MDBRow>
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <h5 className="font-weight-bold mt-4 mb-3">Yashika Sharma</h5>
            ...
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <h5 className="font-weight-bold mt-4 mb-3">Robert Green</h5>
